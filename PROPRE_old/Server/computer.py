...
class FlightComputer:
    ...
    def __init__(self, state):
        ...
        # Debug options:
        self.deliver_printer = True

        # The type of the flight computer
        self.type = 'Normal'
...
def allocate_specific_flight_computer(state, type_idx):
    """
    This new method let us making the choice of the
    type of faulty flight computer to create
    """
    computers = [
        FullThrottleFlightComputer,
        RandomThrottleFlightComputer,
