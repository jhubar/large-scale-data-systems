...
def parse_arguments():
    ...
    parser.add_argument("--flight-computers", type=int, default=3, help="Number of flight computers in the cluster (default: 10)")
...
for i in range(args.flight_computers):
    ...
    Popen(["Python3", "run_server.py", "--port", "{}".format(lastPort), "--type", "{}".format(compType)])
    lastPort += 1
